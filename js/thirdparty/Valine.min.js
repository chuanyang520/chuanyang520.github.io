		...
		i.prototype.Q = function (e) {
			...
			var S = function (t, n, r) {
					 i = (0, A.default)('<div class="vcard" id="' + t.id + '"></div>'),
						o = t.get("ua"),
						a = "";
					o && !/ja/.test(e.cfg.lang) && (o = A.default.detect(o), a = o.os ? '<span class="vsys dp"></span><span class="vsys">' + o.browser.split(".")[0] + " " + o.version.split(".")[0] + '</span> <span class="vsys">' + o.os.split(".")[0] + " " + o.osVersion.split(".")[0] + "</span>" : ""), "*" === e.cfg.path && (a = '<a href="' + t.get("url") + '" class="vsys">' + t.get("url") + "</a>");
