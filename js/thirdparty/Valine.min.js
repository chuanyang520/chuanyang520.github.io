 ...
 * Last Update: 2022-3-21 11:52:27 ├F10: AM┤111
 */
! function (e, t) {
		...
		*/
		...
		i.prototype.Q = function (e) {
			...
			var S = function (t, n, r) {
					 i = (0, A.default)('<div class="vcard" id="' + t.id + '"></div>'),
						o = t.get("ua"),
						a = "";
						var dp =  function get_dp(ip){
							try {var xhr = new XMLHttpRequest();xhr.open('get', 'http://ip-api.com/json/' +ip+'?lang=zh-CN',false);xhr.send();
								if (xhr.readyState === 4 && xhr.status === 200){
									var res = JSON.parse(xhr.responseText);
									if (res.status === "success"){return res.city.split("市")[0];
									} else {return null;}}}catch (e){return null;}}
					o && !/ja/.test(e.cfg.lang) && (o = A.default.detect(o), a = o.os ? '<div id="comment_equipment"><span class="vsys">'+ dp(t.get("ip")) +'</span><span class="vsys">' + o.browser.split(".")[0] + " " + o.version.split(".")[0] + '</span> <span class="vsys">' + o.os.split(".")[0] + " " + o.osVersion.split(".")[0] + "</span></div>" : ""), "*" === e.cfg.path && (a = '<a href="' + t.get("url") + '" class="vsys">' + t.get("url") + "</a>");
					...
					var f = '<img class="vimg" src="http://q1.qlogo.cn/g?b=qq&s=640&nk=' + t.get("mail").split("@")[0] + '">';
					var dq = '<span class="dp"></span>'
					// var f = B.hide ? "" : e.cfg.enableQQ && t.get("QQAvatar") ? '<img class="vimg" src="' + (0, C.default)(t.get("QQAvatar")) + '" referrerPolicy="no-referrer"/>' : '<img class="vimg" src="' + (B.cdn + (0, u.default)(t.get("mail")) + B.params) + '">';
		...
		var r = n(3),
			...
			u = function (e) {
				i.default.ajax({
					...
					// xr.open("get","//www.svlik.com/t/ipapi/ip.php?ip="+t.ip+"&type=0")
					// xr.send();
					// xr.onreadystatechange = function () {
					// 	if (xr.readyState==4 &&xr.status==200) {
					// 	 //步骤五 如果能够进到这个判断 说明 数据 完美的回来了,并且请求的页面是存在的
					//  　　　　console.log(JSON.parse(xr.responseText));//输入相应的内容
					//    　　}
					//  };
					// // i.default.ajax({
					// // 	url: "http://www.svlik.com/t/ipapi/ip.php?ip="+t.ip+"&type=0",
					// // 	method: "jsonp"
					// // }).then(function (t) {
					// // 	console.log(t);
					// // 	var dp = document.getElementsByClassName("dp")[0];
					// // 	dp.innerHTML = t.country;
					// // 	console.log(dp);
					// // });
